...
# Plotting
pdf(paste0(out.name, "deseq2-pca-1sv_", Sys.Date(), ".pdf"))
...
# Looks promising, but adjusting for SV1 results in PC1 accounting 99.13% of data. Well, considering that svaseq does a form of PC correction, that's probably valid...
